...
public class SharedPreference {
    ...
    private final static String PREF_NAME = "share.pref";
    private final static String COOKIE_NAME = "share.pref";
    ...
    public void putToken(Context context,String key, String value) {
        SharedPreferences pref = context.getSharedPreferences("share",
                MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putString(key, value);
        editor.apply();
